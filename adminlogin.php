...
<body style="background-image: url('admin.jpg'); background-size: cover; background-position: center;">> 
    ...
    <h2 align="center"><font color="#ffffff" size="20" face="segeo print">ADMIN LOGIN</font></h2> 
    <table id="table1"; cellspacing="30px" cellpadding="8%"; align="center">  
<tr> 
    <td align="right"><font color="#ffffff" size="5" face="segeo print">ADMIN EMAIL</font></td>  
         <td>
    <input type="email" placeholder="Enter Email" name="email" required style="HEIGHT:30PX;WIDTH:200PX; padding:5px;"/>
         </td>  
 </tr>  
<tr>  
